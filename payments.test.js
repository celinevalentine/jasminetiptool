describe("payment tests with setups and tear down", function() {
    beforeEach(function() {
    ...
    it("should update current Payment on submitPaymentInfo()", function() {
    ...
    it("should not create a new payment on createCurPayment()", function() {
        billAmtInput.value = "";
        tipAmtInput.value = "";
